...
?>
<!DOCTYPE html>
<!-- saved from url=(0063)gindex.php -->
<html lang="en" dir="rtl" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface no-generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <!-- Start JS -->        
    ...
    <script src="./res/employees/akkhor/js/modernizr-3.6.0.min.js"></script>
        ...
        <div class="xp-leftbar">    
            ...
            <div class="xp-sidebar text-right">
                ...
                <div class="xp-logobar>
                    <a href="gindex.php" class="xp-logo"><img src="index_files/UOITC.svg" class="img-fluid" alt="UOITC">
                ...
                <div class="xp-navigationbar active">
                    <ul class="xp-vertical-menu in">
                        ...
                        <li class="active">
                            <a href="gindex.php" class="active">
                        ...
                        <li>
                            ...
                            <ul class="xp-vertical-submenu">
                                ...
                                <li><a href="javaScript:load_inside('./list-files.html','xp-contentbar');">عرض الوثائق</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="xp-vertical-submenu">
                                <li class="nav-item">
                            <a href="gindex.php?page=res/employees/subsys/all-student" class="nav-link"><i></i>كل
                                        الطلبة</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <a href="javaScript:load_inside('./res/employees/subsys/student-promotion.php','xp-contentbar');" class="nav-link"><i
                                ...
                                <li class="nav-item">
                            <a href="gindex.php?page=res/employees/time-line" class="nav-link class="nav-link"><i
                                           ></i>مراحل التسجيل</a>
                                </li>
                            </ul>
                        </li>
...
-->
    ...
    <script src="./index_files/gfunctions.js"></script>
...
//console.log("my_name is : "+my_name);
    ...
    messaging.onMessage(function (payload) {
     ...
     if (payload.notification.body == "message"){
         ...
         mspn++;
     $(".mspan").text(mspn);
     $('#mul1 li:nth-child(1)').after('<li class="media xp-msg"> <img class="mr-3 align-self-center rounded-circle" src="./index_files/user-hussein0.jpg" alt="Generic placeholder image"> <div class="media-body"> <a href="gindex.php?page=test-mail">  <h5 class="mt-0 mb-1 font-14">حسين محمد<span class="font-12 f-w-4 float-right">الان</span></h5> <p class="mb-0 font-13">يرجى الاطلاع على الاعمام التالي<span class="badge badge-pill badge-success float-right">1</span></p> </a> </div> </li>');
