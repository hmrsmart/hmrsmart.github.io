...
<script>
 ...
 function load_country_data(limit, start)
 {
  $.ajax({
   url:"data-load.php",
   method:"POST",
   data:{limit:limit, start:start, sfld1:sfld0, sfld2:sfld1, sfld3:sfld2, tbl:3},
   cache:false,
...
//------------------------------	   
                    ...
                    inp += '<td><a href="#" onclick="load_inside(\'email-open.php?id='+set[i].id+'&eid='+set[i].from_id+'\',\'xp-email-rightbar\')">'+set[i].from_name+'</a></td>';
